...
const libraries:Library[] = [
	...
	},
	{
	  ...
	  "osm_id": "",
	  "address": "Annex at Point Chevalier Community Centre, 18 Huia Road, Pt Chevalier",
	  "visited": false,
	  "libraryId": 39
	},
	{
...
export default function Home() {const Map = useMemo(() => dynamic(
    ...
    <div className="grid grid-rows-[20px_1fr_20px] items-center justify-items-center min-h-screen p-8 pb-20 gap-16 sm:p-20 font-[family-name:var(--font-geist-sans)]">
      <main className="flex flex-col gap-8 row-start-2 items-center sm:items-start">
       <div >
		...
		Avondale Library</div> 
		<div style={{height:'100vh', width:'50vw'}}>
		<Map startPosition={[-36.8977, 174.9188]} zoom={11} libraries={libraries}/>
		</div>
      </main>
